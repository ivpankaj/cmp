...
const AboutUsPage = () => {
  ...
  const message = encodeURIComponent(
    "Hii Team, cookmypapers, !!  I want to know you more!"
  ); // Pre-filled message
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <section className="mb-20 text-center">
            ...
            <div className="flex flex-col items-center max-w-3xl mx-auto">
              <p className="text-gray-400">
                ...
                innovation, collaboration, and a relentless focus on delivering
                value to our users.
              </p>
            </div>
          </section>
          ...
          <section className="mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="p-6 rounded-xl backdrop-blur-sm bg-white/10 border border-white/20 transform hover:scale-105 transition-all duration-300">
                <p className="text-gray-400 italic">
                  &quot;Their expertise in tech tools and website making helped
                  us scale our operations significantly. Highly recommend their
                  services!&quot;
                </p>
                <p className="text-white font-medium mt-4">
